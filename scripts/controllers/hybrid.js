 ...
 */
 ...
 .controller('HybridCtrl',  ['$scope', '$http','$document', 'roundProgressService', '$interval', '$timeout', '$window', function($scope, $http, $document, roundProgressService, $interval, $timeout, $window) {
	...
	var current = [];
    var totHeight = document.getElementById('wd_in_number_hybrid');
