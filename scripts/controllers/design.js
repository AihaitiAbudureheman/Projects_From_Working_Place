 ...
 */
 ...
 .controller('DesignCtrl',  ['$scope', '$http','$document', 'roundProgressService', '$interval', '$timeout', '$window', function($scope, $http, $document, roundProgressService, $interval, $timeout, $window) {
