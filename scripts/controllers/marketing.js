...
/**
 * @ngdoc function
 * @name wdcApp.controller:MarketingCtrl
 * @description
 * # MarketingCtrl
 * Controller of the wdcApp
 */
 angular.module('wdcApp')
 .controller('MarketingCtrl',  ['$scope', '$http','$document', 'roundProgressService', '$interval', '$timeout', '$window', function($scope, $http, $document, roundProgressService, $interval, $timeout, $window) {
